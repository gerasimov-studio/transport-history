...
const messages = {
  en: {
    ...
    'studio.commit': 'Commit', 'studio.commitContents': 'Commit contents', 'studio.localChanges': 'Unsaved local changes',
    'studio.commitSaved': 'Commit saved', 'studio.noChanges': 'No changes', 'studio.createCommit': 'Create commit',
    'studio.updateCommit': 'Update commit', 'studio.discardLocal': 'Discard local changes',
    'studio.eventChanged': 'event details changed', 'studio.infraChanged': 'infrastructure changed', 'studio.infraRemoved': 'infrastructure removed',
    'studio.routesChanged': 'routes changed', 'studio.routesRemoved': 'routes removed',
  ...
  sr: {
    ...
    'studio.points': 'Tačke',
    'studio.commit': 'Komit', 'studio.commitContents': 'Sadržaj komita', 'studio.localChanges': 'Nesačuvane lokalne izmene',
    'studio.commitSaved': 'Komit je sačuvan', 'studio.noChanges': 'Nema izmena', 'studio.createCommit': 'Napravi komit',
    'studio.updateCommit': 'Ažuriraj komit', 'studio.discardLocal': 'Odbaci lokalne izmene',
    'studio.eventChanged': 'podaci događaja izmenjeni', 'studio.infraChanged': 'infrastruktura izmenjena', 'studio.infraRemoved': 'infrastruktura uklonjena',
    'studio.routesChanged': 'linije izmenjene', 'studio.routesRemoved': 'linije uklonjene',
  ...
  ru: {
    ...
    'studio.points': 'Точки',
    'studio.commit': 'Коммит', 'studio.commitContents': 'Состав коммита', 'studio.localChanges': 'Есть локальные правки',
    'studio.commitSaved': 'Коммит сохранён', 'studio.noChanges': 'Изменений нет', 'studio.createCommit': 'Создать коммит',
    'studio.updateCommit': 'Обновить коммит', 'studio.discardLocal': 'Отменить локальные правки',
    'studio.eventChanged': 'описание события изменено', 'studio.infraChanged': 'инфраструктура изменена', 'studio.infraRemoved': 'инфраструктура удалена',
    'studio.routesChanged': 'маршруты изменены', 'studio.routesRemoved': 'маршруты удалены',
